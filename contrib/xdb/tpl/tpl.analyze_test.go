...
func Test_NewFixed_AnalyzeTPLFromCache(t *testing.T) {
	...
	fixedtemplate := NewFixed("test", "?", xdb.NewDefaultTemplateMatcher(expression.DefaultExpressionMatchers...))
	...
	tests := []struct {
		...
		{name: "a-1-3.", tpl: "&{f}", input: map[string]any{"f": "1"}, wantSql: "and f=?", wantValues: []any{"1"}},
		{name: "a-1-4.", tpl: "&{t.f}", input: map[string]any{"f": "1"}, wantSql: "and t.f=?", wantValues: []any{"1"}},
		{name: "a-1-5.", tpl: "|{f}", input: map[string]any{"f": "1"}, wantSql: "or f=?", wantValues: []any{"1"}},
		{name: "a-1-6.", tpl: "|{t.f}", input: map[string]any{"f": "1"}, wantSql: "or t.f=?", wantValues: []any{"1"}},

		{name: "a-2-1.", tpl: "f=@{f} and b=@{f}", input: map[string]any{"f": "1"}, wantSql: "f=? and b=?", wantValues: []any{"1", "1"}},
		{name: "a-2-2.", tpl: "f=${f} and b=@{f}", input: map[string]any{"f": "1"}, wantSql: "f=1 and b=?", wantValues: []any{"1"}},
		...
		{name: "b-1-1.", tpl: "&{like f}", input: map[string]any{"f": "1"}, wantSql: "and f like ?", wantValues: []any{"1"}},
		{name: "b-1-2.", tpl: "&{like t.f}", input: map[string]any{"f": "1"}, wantSql: "and t.f like ?", wantValues: []any{"1"}},
		{name: "b-1-3.", tpl: "&{like %f}", input: map[string]any{"f": "1"}, wantSql: "and f like '%'+?", wantValues: []any{"1"}},
		{name: "b-1-4.", tpl: "&{like %t.f}", input: map[string]any{"f": "1"}, wantSql: "and t.f like '%'+?", wantValues: []any{"1"}},
		{name: "b-1-5.", tpl: "&{like %f%}", input: map[string]any{"f": "1"}, wantSql: "and f like '%'+?+'%'", wantValues: []any{"1"}},
		{name: "b-1-6.", tpl: "&{like %t.f%}", input: map[string]any{"f": "1"}, wantSql: "and t.f like '%'+?+'%'", wantValues: []any{"1"}},
		...
		{name: "d-1-2.", tpl: "&{>= t.f}", input: map[string]any{"f": "1"}, wantSql: "and t.f>=?", wantValues: []any{"1"}},
		{name: "d-1-3.", tpl: "&{< f}", input: map[string]any{"f": "1"}, wantSql: "and f<?", wantValues: []any{"1"}},
		{name: "d-1-4.", tpl: "&{<= t.f}", input: map[string]any{"f": "1"}, wantSql: "and t.f<=?", wantValues: []any{"1"}},
		{name: "d-1-5.", tpl: "&{= t.f}", input: map[string]any{"f": "1"}, wantSql: "and t.f=?", wantValues: []any{"1"}},

		{name: "d-2-1.", tpl: "&{field > f}", input: map[string]any{"f": "1"}, wantSql: "and field>?", wantValues: []any{"1"}},
		{name: "d-2-2.", tpl: "&{t.field >= f}", input: map[string]any{"f": "1"}, wantSql: "and t.field>=?", wantValues: []any{"1"}},
		{name: "d-2-3.", tpl: "&{field < f}", input: map[string]any{"f": "1"}, wantSql: "and field<?", wantValues: []any{"1"}},
		{name: "d-2-4.", tpl: "&{t.field <= f}", input: map[string]any{"f": "1"}, wantSql: "and t.field<=?", wantValues: []any{"1"}},
		{name: "d-2-5.", tpl: "&{t.field = f}", input: map[string]any{"f": "1"}, wantSql: "and t.field=?", wantValues: []any{"1"}},
	}
...
func Test_NewSeq_AnalyzeTPLFromCache(t *testing.T) {
	...
	fixedtemplate := NewSeq("test", ":", xdb.NewDefaultTemplateMatcher(expression.DefaultExpressionMatchers...))
