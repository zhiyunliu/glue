...
func (r *Redis) Append(message queues.Messager) error {
...
func (r *Redis) Register(stream string, f queues.ConsumerFunc) {
	r.consumer.Register(stream, func(message *redisqueue.Message) error {
		m := new(Message)
